        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="text-blue-600 dark:text-blue-400 font-semibold">응답 속도 최대 40% 개선</span>, <span className="text-indigo-600 dark:text-indigo-400 font-semibold">처리 성능 3.4배 향상</span> 등 수치 기반의 성능 개선 경험을 보유하고 있습니다.<br />
              기술 블로그 작성과 인터넷 강의 및 개발 서적을 통한 <span className="text-green-600 dark:text-blue-400 font-semibold">지속적인 학습과 지식 공유</span>를 실천하며, <span className="text-sky-600 dark:text-indigo-400 font-semibold">기술적 실험과 개선을 통해 팀에 더 나은 방향을 제시하는 개발자</span>를 지향합니다.
            </p>
          </div>
